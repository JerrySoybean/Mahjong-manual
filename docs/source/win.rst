...
* **混幺九**：只包含 1、9 和字牌。注意，**混幺九** 一定是 **对对和**，所以一般认为 **混幺九** 不是 **对对和** 的特殊情况。因此如果视为 **混幺九**，则 **可能** 要排除 **（基本）对对和**。如
  ...
  * **十三幺**：所有幺张各一张，其中有一个幺张是一对将。（**幺张** 就是指 1、9 和字牌。）如
...
* **清一色**：只有一种花色（全饼 或 全条 或 全万 或 全字（包含风和箭）。如
  ...
  * **字一色**：只有字牌（包含风和箭）。注意，**字一色** 一定是 **对对和** 和 **混幺九**，所以一般认为 **字一色** 是 **清一色** 的特殊情况，而非 **对对和** 和 **混幺九** 的特殊情况。因此如果视为 **字一色**，则 **可能** 要排除 **（基本）对对和** 和 **混幺九**。如
